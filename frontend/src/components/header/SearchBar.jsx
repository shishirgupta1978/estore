...
export const SearchBar = () => {
  ...
  const { category, setCategory, setContext, search, setSearch, axiosApi } = useContext(Context);
  ...
  return (
    <InputGroup style={{ maxWidth: '260px' }}>
      {store_slug &&
        <DropdownButton variant="outline-secondary" title={category.name} id="input-group-dropdown-1" >
