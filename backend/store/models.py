...
class Invoice(models.Model):
    store = models.ForeignKey(StoreProfile,on_delete=models.DO_NOTHING,related_name='invoices')
...
class Order(models.Model):
    invoice=models.ForeignKey(Invoice,on_delete=models.DO_NOTHING,related_name='iorders')
    product=models.ForeignKey(Product,on_delete=models.DO_NOTHING,related_name='porders')
